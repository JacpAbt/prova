...
class Coffee(models.Model):
    ...
    process = models.ForeignKey(Process, on_delete=models.CASCADE, null=True, related_name= 'first_process')
    process_2 = models.ForeignKey(Process, on_delete=models.CASCADE, null=True)
